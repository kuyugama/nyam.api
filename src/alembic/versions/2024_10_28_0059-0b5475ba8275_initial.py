...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_service_roles_created_at"), "service_roles", ["created_at"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_service_roles_updated_at"), "service_roles", ["updated_at"], unique=False
    )
    op.create_table(
        "service_upload_images",
    ...
    op.create_index(
        op.f("ix_service_upload_images_created_at"),
        "service_upload_images",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_service_upload_images_id"), "service_upload_images", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_service_upload_images_updated_at"),
        "service_upload_images",
        ["updated_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_service_users_description"), "service_users", ["description"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_service_users_next_offline"), "service_users", ["next_offline"], unique=False
    )
    op.create_index(op.f("ix_service_users_nickname"), "service_users", ["nickname"], unique=False)
    op.create_index(
        op.f("ix_service_users_pseudonym"), "service_users", ["pseudonym"], unique=False
    )
    op.create_index(
